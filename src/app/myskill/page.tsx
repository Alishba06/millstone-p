...
const MyEperience = () => {
  return (
    <div>
        <Navbar/>
      <h1 className='text-3xl text-center md:text-5xl font-bold m-10  text-white' >My Sills</h1>
      ...
      <h1 className='mt-1 text-lg font-semibold text-gray-800'>TyPscript</h1>
      </div>
